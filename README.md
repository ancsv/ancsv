...
| ---------------------------- | ------------------------------------------------- | ------------------------- |
| **Stegano Gateway**          | AI Steganography Detection & CDR Gateway          | Spring Boot, FastAPI, AWS |
| **CTI Platform**             | Cyber Threat Intelligence Dashboard               | Spring Boot, Docker       |
